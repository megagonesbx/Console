...
export const createIncidentValidationRules = (additionalRules: any = null) => {
  ...
  return [
    genericStringRule(["incidentName", "description", "user"], {
      requiredType: "string",
...
export const updateIncidentValidationRules = (additionalRules: any = null) => {
  ...
  return [
    genericStringRule(["incidentName", "description"], {
      requiredType: "string",
      warnings: "This field doesn't exist, is not a string or is empty.",
    }),
    genericStringRule(
...
export const getIncidentValidationRules = (additionalRules: any = null) => {
  ...
  return [
    genericQueryParamIdRule("incidentId", {
      warnings:
        "The ID doesn't exist in the queryparam, is not a integer or is empty.",
